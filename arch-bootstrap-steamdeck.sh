...
# Usage:
#
#   # arch-bootstrap-steamdeck destination
#
...
DEFAULT_REPO_URL="https://steamdeck-packages.steamos.cloud/archlinux-mirror/"
DEFAULT_ARM_REPO_URL="http://eu.mirror.archlinuxarm.org"
...
show_usage() {
  stderr "Usage: $(basename "$0") [-u USER] [-d DOWNLOAD_DIR] DESTDIR"
}
